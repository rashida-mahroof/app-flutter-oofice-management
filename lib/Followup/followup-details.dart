                      ...
                      child: ExpansionTile(
                        title: Row(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.only(right: 5),
                              child: Icon(Icons.newspaper,color: Color(0xFF1B9E45)),
                            ),
                            Text('Followup details',style: GoogleFonts.poppins(fontSize: 13,fontWeight: FontWeight.w600,color: Colors.grey),),
                          ],
                        ),
                        children: <Widget>[
                          for(int i=1;i<6;i++)
                            ...
                            ListTile(
                              leading: Icon(Icons.arrow_forward_ios_rounded,color: Colors.black45,size: 20,),
                              title: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('CRE follow up details',style: GoogleFonts.poppins(fontSize: 14,color: Colors.black45,fontWeight: FontWeight.w600),),
                              ...
                              subtitle:  Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Followup date: 12/03/2002',style: GoogleFonts.poppins(fontSize: 13,color: Colors.black45,fontWeight: FontWeight.w500),),
                                  Row(
                                    children: [
                                      Text('Response: ',style: GoogleFonts.poppins(fontSize: 13,color: Colors.black45,fontWeight: FontWeight.w500),),
                                      Text('lorem ipsem',style: GoogleFonts.poppins(fontSize: 13,color: Colors.black45,fontWeight: FontWeight.w500),),
                                    ],
                                  ),
                                  Row(
                                    children: [
                                      Text('Note: ',style: GoogleFonts.poppins(fontSize: 13,color: Colors.black45,fontWeight: FontWeight.w500),),
                                      Text('lorem ipsem dolor',style: GoogleFonts.poppins(fontSize: 13,color: Colors.black45,fontWeight: FontWeight.w500),),
                                    ],
                                  ),
                                ],
                              ),
              ...
              children: [
                Expanded(
                    child: ElevatedButton(onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>UpdateFollowup()));
                    },
